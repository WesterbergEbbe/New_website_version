...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  if (tile.value > 2048 && tile.value < 4000) classes.push("tile-super");
  
  if(tile.value > 4096 or tile.value > 4194304) classes.push("esjonne";
...
HTMLActuator.prototype.message = function (won) {
  ...
  var message = won ? "Kultanen ES" : "Game over!";
...
HTMLActuator.prototype.goKatko = function () {
    ...
    messageElement.setAttribute('src',"img/marjamehu.jpg");
    //messageElement.textContent = message;
    //var left = 'left: 50%;';
    //var top = 'top: 10%;';
    ///img/og_katko.png
